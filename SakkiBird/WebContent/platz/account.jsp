					...
					<div class="sign-up-htm">
						...
						<div class="group">
							<label for="pass" class="label">Password</label> <input
							    name = "pw" id="passInput"type="password" class="input" data-type="password">
						</div>
						<div class="group">
							<label for="pass" class="label">Confirm Password</label> <input
								id="passInput1" type="password" class="input" data-type="password">
						</div>
						<div class="group">
							<input id = "idReg" type="button" class="button" value="가입하기" onclick= "sendIt()">
						</div>
						<div class="hr"></div>
						<div class="foot-lnk">
